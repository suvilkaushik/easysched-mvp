...
import { getAppointmentsByClient, mockClients } from '@/lib/data';
...
export default function ClientPortal() {
  ...
  const appointments = getAppointmentsByClient(selectedClientId);
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-3xl font-bold mt-2">
              {appointments.filter(a => a.status === 'scheduled' && a.startTime > new Date()).length}
            </p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex gap-2">
                      {appointment.status === 'scheduled' && appointment.startTime > new Date() && (
                        <>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <p className="text-blue-800">
            Soon you&apos;ll be able to book appointments by phone! Our AI voice receptionist will answer your calls,
            understand your needs, and schedule appointments automatically. You&apos;ll also receive iMessage reminders
            for your upcoming appointments.
          </p>
        </div>
      </main>
    </div>
